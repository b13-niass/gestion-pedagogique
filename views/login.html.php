<div class="h-[calc(var(--vh,1vh)_*_100)] w-full overflow-y-auto scrollbar">
    ...
    <div class="flex flex-col justify-center w-full max-w-[516px] px-[30px] mx-auto my-[150px]">
        ...
        <div class="rounded-6 mt-[25px] shadow-xl dark:shadow-xl bg-[#111726] dark:bg-[#111726]">
            <div class="p-[25px] text-center border-b border-white/[.05] dark:border-white/[.05] top">
                <!-- Heading for the login form -->
                <h2 class="text-18 font-semibold leading-[1] mb-0 text-title-dark dark:text-title-dark">Connectez-vous</h2>
            </div>
            ...
            <div class="py-[30px] px-[40px]">
                <form action="/login" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="email-usernameId" class="text-[14px] w-full leading-[1.4285714286] font-medium text-gray-300 dark:text-gray-300 mb-[8px] capitalize inline-block">Email
                            Email</label>
                    ...
                    <!-- Password input -->
                    <div class="mb-6">
                        <label for="passwordId" class="text-[14px] w-full leading-[1.4285714286] font-medium text-gray-300 dark:text-gray-300 mb-[8px] capitalize inline-block">
                            Mot de passe</label>
        ...
        <div class="<?= (isset($connectionError) && !empty($connectionError)) ? '' : 'hidden' ?> p-[25px] pt-0 flex flex-col gap-[15px]">
            <div class="hidden w-full data-[te-alert-show]:inline-flex px-[20px] py-[10px] text-[14px] rounded-lg bg-danger/10 text-danger border-1 border-success/10 capitalize justify-between flex-wrap items-center  transition-all duration-300 ease-linear " role="alert" data-te-alert-init="" data-te-alert-show="">
                ...
                <button type="button" class="box-content border-none rounded-none opacity-50 ms-auto hover:text-warning-900 hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none text-title-dark dark:text-title-dark" data-te-alert-dismiss="" aria-label="Close">
